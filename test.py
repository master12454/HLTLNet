...
parser.add_argument("--model_names", default=['LTLNet'], nargs='+',
                    help="model_name: 'LTLNet'")
parser.add_argument("--pth_dirs", default=['./best_weight/LTLNet_NUDT_best.pth.tar','./best_weight/LTLNet_NUAA_best.pth.tar','./best_weight/LTLNet_IRSTD_best.pth.tar'], nargs='+',
                    help="checkpoint dir, default=['./best_weight/LTLNet_NUDT_best.pth.tar','./best_weight/LTLNet_NUAA_best.pth.tar','./best_weight/LTLNet_IRSTD_best.pth.tar']")
parser.add_argument("--dataset_dir", default='./datasets', type=str, help="train_dataset_dir")
parser.add_argument("--dataset_names", default=['NUAA', 'NUDT', 'IRSTD'], nargs='+',
...
parser.add_argument("--save_img_dir", type=str, default='./best_resultss/', help="path of saved image")
parser.add_argument("--save_log", type=str, default='./best_weight/', help="path of saved .pth")
...
def test():
    ...
    net = Net(model_name=opt.model_name, dataset_name=opt.test_dataset_name, mode='test').cuda()
    try:
    ...
    eval_PD_FA = PD_FA()
    with torch.no_grad():
        tbar = tqdm(test_loader, desc="test ")
